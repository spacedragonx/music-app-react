  ...
  return (
    <>
      ...
      <div className="container">
        ...
        <div className="frnt row my-100">
          <div className=" relative col-12 py-5 text-center ">
            <h1 class="nme">
              <i className="bi bi-music-note-list mt-500 "></i>
              BeatBlend
            </h1>
            <h3 className=" hz py-5 mx-5 ">Discover music in 30 seconds</h3>
            <div class="Gitlink">
              <a
                target="_blank"
                rel="noreferrer"
                className="gitanchor btn btn-outline-dark"
                href="#"
              >
